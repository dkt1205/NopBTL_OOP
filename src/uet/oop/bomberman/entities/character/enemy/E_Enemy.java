...
import uet.oop.bomberman.entities.character.enemy.ai.AIMove;
...
public abstract class E_Enemy extends C_Character {

    protected int _points;
    protected double _speed;
    protected AIMove _ai;
    ...
    public boolean canMove(double x, double y) {
        ...
        All_Entity a = _board.getEntity(xx, yy, this); //entity of the position we want to go
